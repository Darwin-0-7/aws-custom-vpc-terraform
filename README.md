...
git clone https://github.com/Darwin-0-7/aws-custom-vpc-terraform.git
cd aws-custom-vpc-terraform

2. Initialize Terraform (Downloads the necessary AWS provider plugins)
terraform init

3. Preview the execution plan (Verifies the resources that will be created)
terraform plan

4. Deploy the infrastructure (Type 'yes' when prompted)
terraform apply

5. Access the Web Server
Once the apply is complete, Terraform will output the public IP address of the EC2 instance. Copy the IP and open it in your browser:
http://<web_server_public_ip>

## 🧹 Cleanup
To avoid incurring unnecessary AWS charges, destroy the infrastructure once testing is complete:
terraform destroy
